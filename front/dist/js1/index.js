    ...
    new Vue({
        ...
        data: { //数据
            ...
            questionsArry: ["精力充沛吗吗？精力力吗？精力力充沛吗沛吗精力充沛吗精力充沛吗", "容易疲乏吗？", "说话声音体弱无力吗？", "感到闷闷不乐，情绪低沉吗？",
                "比一般人耐受不了寒冷吗？", "比一般人耐受不了寒冷吗？", "比一般人耐受不了寒冷吗？", "能适应外界自然和社会环境的变化？", "容易失眠吗？", "容易忘事（健忘）吗？"],
            chooseArry: [
                ["第一题没有（根本不）不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第二题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第三题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第四题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第五题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第六题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第七题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第八题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第九题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"],
                ["第十题没有（根本不）", "很少（有一点）", "有时（有些）", "经常（相当）", "总是（非常）"]]
                ...
                if (this.answerMap.get(index) >= 0) {
                    ...
                    if (index == this.questionsArry.length - 1) {
                        ...
                        for (let [key, val] of this.answerMap) {
                            ...
                            if (val == 4)
                                answerInfo = 0;
                            answerInfo1 += answerInfo;
                        }
                        answerInfo1 = "您的得分为：" + String(answerInfo1);
                        alert(answerInfo1)//alert() 方法用于显示带有一条指定消息和一个 OK 按钮的警告框。
                        console.log(answerInfo1);
